...
usersProfit,
  ...
  {loading || !stats ?  (<Loader color='purple.500' />):(
    ...
    >
     ...
     <Databox title="Subscription" qty ={subscriptionCount} qtyPercentage={subscriptionPercentage} profit={usersProfit} />
      </Stack>
      <Box
      m={['0','16']}
      borderRadius={'lg'}
    ...
    <Grid templateColumns={["1fr" ,"2fr 1fr"]} >
      <Box p={"4"} >
          ...
          <Box>
              ...
              <Bar profit={subscriptionProfit}  title={'Subsription'} value={subscriptionPercentage} />
