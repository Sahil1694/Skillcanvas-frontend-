...
return <>
    ...
    <Button
     onClick={onOpen}
     colorScheme={"yellow"} width= '12' height={'12'} rounded="full" position={"fixed"} zIndex={'overlay'} top= "6" left= "6">
        <RiMenu5Fill />
    </Button>
    ...
    <Drawer placement='left'  onClose={onClose} isOpen={isOpen}>
        ...
        <DrawerContent>
        <DrawerHeader borderBottomWidth={"1px"}>SKILL CANVAS</DrawerHeader> 
        <DrawerBody>
...
<HStack justifyContent={"space-evenly"} position= "absolute" bottom={"2rem"} width="80%">
  ...
  <Button colorScheme="purple" variant="ghost">
    ...
    <Link onClick={onClose} to = "/login">
        <Button colorScheme={'yellow'}>Login
        </Button>
    </Link>

    <p>OR</p>
    <Link onClick={onClose} to = "/Register">
        <Button colorScheme={'yellow'}>Sign Up
        </Button>
    </Link> 
    </>)}
    </HStack>
